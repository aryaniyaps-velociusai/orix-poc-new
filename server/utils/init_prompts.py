...
async def initialize_prompts():
    ...
    try:
        ...
        client = CosmosClient(
            DATABASE_URI, credential=DATABASE_KEY, transport=transport
        )
...
async def check_and_update_prompt(
    container, item_id, new_prompt, current_version, job_id
):
    """
